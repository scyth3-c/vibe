...
constexpr auto VER_EPOLL_RANGE =  "AN ERROR OCCURRED WHEN CREATION OF THE EPOLL_FD FILE DESCRIPTOR";
constexpr auto VER_EPOLL_CTL =    "AN ERROR OCCURRED WHEN EXECUTING EPOLL_CTL";
constexpr auto VER_EPOLL_CERR =   "THE FOLLOWING ERROR WAS FOUND WHEN EXECUTING THE EPOLL METHOD: ";
