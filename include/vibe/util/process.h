...
// use. Node.js-style access through the global vibe::process object:
//
//   vibe::process.pwd        // directory containing the executable
//   vibe::process.cwd        // working directory the process was launched from
//   vibe::process.exec_path  // absolute path of the executable
//   vibe::process.pid        // process id
//   vibe::process.uptime()   // seconds since the process started
//

#ifndef VIBE_PROCESS_H
#define VIBE_PROCESS_H
